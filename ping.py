...
#создание героя
platform_l = platform_L(img_platform1, 50, win_height/2, 30, 130, 2)
platform_r = platform_R(img_platform2, 920, win_height/2, 30, 130, 2)
ball = ball(img_ball, 475,win_height/2,50,50,1)
while run:
    for e in event.get():
        if e.type == QUIT :
            run = False
